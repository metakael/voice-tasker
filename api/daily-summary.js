...
export default async function handler(req, res) {
  try {
    ...
    const dailySummary = generateDailySummary(analyzedTasks);
    const telegramMessage = formatSummaryForTelegram(dailySummary);
    ...
    return sendJson(res, 200, { success: true, summary: dailySummary, taskCount: allTasks.length });
  } catch (error) {
